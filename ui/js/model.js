...
function hardDeleteItem(id){
  ...
  boardDelete(id);                    // доска полотна лежит отдельно от ноды — унести вместе с ней
...
/* ЗАПИСЫВАЕТ дом не этот файл, а граф (Graph._homeFromDrag): считать смещение надо от ЖИВОЙ позиции
