...
const ТУР=[
  ...
  {v:"2.0.5.1", значок:"ti-drag-drop", ttl:"Выделил несколько — тащи за любую",
   txt:"Выдели рамкой или с Shift несколько нод и тяни любую из них — остальные едут следом, не теряя расположения. Раньше куст приходилось переносить по одной ноде. При включённом «Держать раскладку» новое место запомнится сразу всей группе.",
   before(){ view="notes"; notesMode="graph"; render(); }},
];
